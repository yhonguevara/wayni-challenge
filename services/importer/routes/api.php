...
/*
 * API v1 — all importer endpoints are prefixed with /v1.
 * The 'api' prefix is already applied by the route service provider,
 * so the effective URLs are /api/v1/upload, /api/v1/presign, /api/v1/notify-upload.
 */
Route::prefix('v1')->group(function (): void {
    // Direct upload endpoint (local path). Kept for CLI / small files.
