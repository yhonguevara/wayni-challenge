...
final class ProcessBcraFile implements ShouldQueue
{
    ...
    /**
     * Disable the job timeout — the ELT pipeline for the full 5.6 GB file
     * (COPY-load to staging + GROUP BY aggregation of ~34M rows) runs for tens
     * of minutes. A non-zero timeout would kill the job prematurely.
